...
const pages = [
  ...
  },
  {
    ...
    title: "Burnos higiena (dantų) Klaipėdoje  nuo 60€ | Bangų klinika",
  ...
  },
  {
    ...
    title: "Dantų plombavimas Klaipėdoje nuo 40€ | Bangų klinika",
  ...
  },
  {
    ...
    title: "Estetinis dantų plombavimas Klaipėdoje nuo 150€ | Bangų klinika",
  ...
  },
  {
    ...
    title: "Burnos chirurgija Klaipėdoje nuo 60€ | Bangų klinika",
  ...
  },
  {
    ...
    title: "Dantų balinimas Klaipėdoje 250€ | Bangų klinika",
  ...
  },
  {
    ...
    title: "Dantų gydymas, taisymas (tvarkymas) Klaipėdoje nuo 40€ | Bangų klinika",
  ...
  },
  {
    ...
    title: "Vaikų odontologija (stomatologija) Klaipėdoje nuo 50€ | Bangų klinika",
  ...
  },
  {
    ...
    title: "Dantų protezavimas Klaipėdoje - Dantų protezai nuo 350€ | Bangų klinika",
  ...
  },
  {
    ...
    title: "Dantų traukimas (rovimas) Klaipėdoje nuo 60€ | Bangų klinika",
  ...
  },
  {
    ...
    title: "Dantų tiesinimas Klaipėdoje nuo 1800€ | Bangų klinika",
  ...
  },
  {
    ...
    title: "Endodontinis (šaknų kanalų) gydymas Klaipėdoje nuo 70€ | Bangų klinika",
  ...
  { route: "/lv/pakalpojumi/neatliekama-palidziba",         title: "Neatliekamā zobārstniecības palīdzība Klaipēdā | Bangų klinika",  description: "Neatliekamā zobārstniecības palīdzība Klaipēdā – ātra reakcija uz asām sāpēm, traumām un iekaisumiem." },
  { route: "/lv/pakalpojumi/straumann-implanti",            title: "Straumann zobu implanti Klaipēdā | Bangų klinika",                 description: "Straumann zobu implanti Klaipēdā – Šveices kvalitāte un ilgtermiņa risinājums." },
  { route: "/lv/pakalpojumi/sinusa-pacelsana",              title: "Sinusa pacelšana Klaipēdā | Bangų klinika",                        description: "Sinusa pacelšana (sinusa lifts) Klaipēdā – kaula tilpuma palielināšana implantācijai." },
  { route: "/lv/pakalpojumi/zoklakaula-augmentacija",       title: "Žokļa kaula augmentācija Klaipēdā | Bangų klinika",                description: "Žokļa kaula augmentācija Klaipēdā – kaula veidošana veiksmīgai implantācijai." },
  { route: "/lv/pakalpojumi/gudribas-zobu-izvilksana",      title: "Gudrības zobu izvilkšana Klaipēdā | Bangų klinika",                description: "Gudrības zobu izvilkšana Klaipēdā – droša un profesionāla ķirurģiska procedūra." },
  { route: "/lv/pakalpojumi/abscesa-atversana",             title: "Abscesa atvēršana Klaipēdā | Bangų klinika",                       description: "Abscesa atvēršana Klaipēdā – ātra sāpju mazināšana un iekaisuma ārstēšana." },
  { route: "/lv/pakalpojumi/tulitejas-implantacija",        title: "Tūlītējā implantācija Klaipēdā | Bangų klinika",                   description: "Tūlītējā zobu implantācija Klaipēdā – implants tiek ievietots uzreiz pēc zoba izvilkšanas." },
  { route: "/lv/pakalpojumi/visi-zobi-uz-4-implantiem",     title: "Visi zobi uz 4 implantiem (All-on-4) Klaipēdā | Cena no 3800€ | Bangų klinika", description: "Visi zobi uz 4 implantiem (All-on-4) Klaipēdā – uzticams, moderns risinājums visas zobu rindas atjaunošanai. Pierakstieties konsultācijai Bangų klīnikā." },
  { route: "/lv/pakalpojumi/cirkonija-keramikas-kronitis",  title: "Cirkonija keramikas kronītis Klaipēdā | Bangų klinika",            description: "Cirkonija keramikas kronītis Klaipēdā – dabiska izskata un ilgmūžīga zobu atjaunošana." },
  { route: "/lv/pakalpojumi/zobu-kroniti",                  title: "Zobu kronīši Klaipēdā | Bangų klinika",                            description: "Zobu kronīši Klaipēdā – dažādi materiāli un individuāla pieeja katram pacientam." },
  { route: "/lv/pakalpojumi/zobu-tilti",                    title: "Zobu tilti Klaipēdā | Bangų klinika",                              description: "Zobu tilti Klaipēdā – trūkstošo zobu atjaunošana ar ilgstošu risinājumu." },
  { route: "/lv/pakalpojumi/mikroprotezesana",              title: "Zobu mikroprotezēšana Klaipēdā | Bangų klinika",                   description: "Zobu mikroprotezēšana Klaipēdā – saudzīga zobu atjaunošana ar inlejām un onlejām." },
  { route: "/lv/pakalpojumi/zobu-uzlikas",                  title: "Zobu uzlikas Klaipēdā | Bangų klinika",                            description: "Zobu uzlikas (onlejas) Klaipēdā – estētiska un ilgmūžīga zobu atjaunošana." },
  { route: "/lv/pakalpojumi/iznemamas-protezes",            title: "Izņemamās zobu protēzes Klaipēdā | Bangų klinika",                 description: "Izņemamās protēzes Klaipēdā – daļējas un pilnas protēzes atbilstoši Jūsu vajadzībām." },
  { route: "/lv/pakalpojumi/protezesanas-kompensacija",     title: "Zobu protezēšanas kompensācija | Bangų klinika",                    description: "Kompensētā zobu protezēšana Klaipēdā – informācija par tiesībām un procesu." },
  { route: "/lv/pakalpojumi/terapeitiska-arstesana",        title: "Terapeitiskā zobu ārstēšana Klaipēdā | Bangų klinika",             description: "Terapeitiskā zobu ārstēšana Klaipēdā – kariesa un zobu iekaisumu ārstēšana." },
  { route: "/lv/pakalpojumi/arstesana-icon-sistema",        title: "Ārstēšana ar ICON sistēmu Klaipēdā | Bangų klinika",               description: "Kariesa ārstēšana ar ICON sistēmu Klaipēdā – bez urbšanas, bez sāpēm." },
  { route: "/lv/pakalpojumi/smaganu-iekaisums-gingivits",   title: "Smaganu iekaisums (gingivīts) Klaipēdā | Bangų klinika",           description: "Gingivīta ārstēšana Klaipēdā – smaganu veselības atjaunošana un profilakse." },
  { route: "/lv/pakalpojumi/bruksisma-kapa",                title: "Bruksisma kapa Klaipēdā | Bangų klinika",                          description: "Bruksisma kapa Klaipēdā – individuāli izgatavota aizsardzība zobu griešanas gadījumā." },
  { route: "/lv/pakalpojumi/zobu-balinesanas-kapas",        title: "Zobu balināšanas kapas Klaipēdā | Bangų klinika",                  description: "Zobu balināšanas kapas Klaipēdā – ērts un efektīvs risinājums balināšanai mājās." },
  { route: "/lv/pakalpojumi/zobu-balinesana-ar-lampu",      title: "Zobu balināšana ar lampu Klaipēdā no 270€ | Bangų klinika",        description: "Zobu balināšana ar lampu Klaipēdā – efektīvs veids, kā paspilgtināt zobus un atgūt starojošu smaidu. Pierakstieties procedūrai Bangų klīnikā." },
  { route: "/lv/pakalpojumi/zobu-fluoresana",               title: "Zobu fluorēšana Klaipēdā | Bangų klinika",                         description: "Zobu fluorēšana Klaipēdā – emaljas stiprināšana un kariesa profilakse." },
  { route: "/lv/pakalpojumi/bernu-profilaktiska-parbaude",  title: "Bērnu profilaktiskā pārbaude Klaipēdā | Bangų klinika",            description: "Bērnu zobu profilaktiskā pārbaude Klaipēdā – kariesa un problēmu agrīna atklāšana." },
  { route: "/lv/pakalpojumi/bernu-mutes-higiena",           title: "Bērnu mutes higiēna Klaipēdā | Bangų klinika",                     description: "Bērnu profesionālā mutes higiēna Klaipēdā – maiga pieeja mazajiem pacientiem." },
  { route: "/lv/pakalpojumi/rentgena-izmeklejumi",          title: "Rentgena izmeklējumi Klaipēdā | Bangų klinika",                    description: "Digitālie rentgena izmeklējumi Klaipēdā – panorāmas uzņēmumi un 3D CBCT." },
  { route: "/lv/musu-darbi",                                title: "Mūsu darbi | Bangų klinika Klaipēdā",                              description: "Bangų klīnikas paveiktie zobārstniecības darbi Klaipēdā – reāli pacientu gadījumi pirms un pēc." },
  { route: "/lv/raksti",                                     title: "Raksti par zobu veselību | Bangų klinika",                          description: "Noderīga informācija par zobu veselību, ārstniecību un aprūpi. Zobārstu padomi un atbildes uz biežāk uzdotajiem jautājumiem." },
  { route: "/lv/raksti/zobu-griesana-nakti-kad-palidz-kapa", title: "Zobu griešana naktī: kad palīdz kapa? | Bangų klinika",             description: "Zobu bruksisms bieži paliek nepamanīts, taču ilgtermiņā tas var bojāt zobu emalju. Kā zināt, vai vajadzīga aizsargkapa?" },
  { route: "/lv/raksti/ka-notirit-zobakmens",                title: "Kā notīrīt zobakmens? | Bangų klinika",                             description: "Zobakmens ir nogulsnes, kuras zobu suka un pasta vairs nespēj noņemt. Kā tos droši notīra profesionāli un ko var izdarīt mājās?" },
  { route: "/lv/raksti/kariess-bez-urbsanas-ko-var-darit-klinika-un-majas", title: "Kariess bez urbšanas: ko var darīt klīnikā un mājās? | Bangų klinika", description: "Kariess bez urbšanas iespējams tikai noteiktās slimības stadijās. Kā to droši kontrolēt un kad zobs vairs nav glābjams bez restaurācijas?" },
  { route: "/lv/raksti/ka-drosi-balinat-zobus-majas",        title: "Kā droši balināt zobus mājās? | Bangų klinika",                     description: "Zobu balināšana mājās var palīdzēt paspilgtināt dabīgo zobu krāsu. Kuras metodes patiešām darbojas un no kā izvairīties?" },
  { route: "/lv/raksti/ko-darit-kad-veidojas-zoba-abscess",  title: "Ko darīt, kad veidojas zoba abscess? | Bangų klinika",              description: "Zoba abscess ir bakteriālas infekcijas izraisīts strutu uzkrājums. Kāpēc to nedrīkst atlikt un kā zobārsts to ārstē?" },
  { route: "/lv/raksti/kaula-augmentacija-kas-jazina-pirms-operacijas", title: "Kaula augmentācija: kas jāzina pirms operācijas? | Bangų klinika", description: "Ja žoklī nepietiek kaula zoba implantam, pirms implantācijas var būt nepieciešama kaula augmentācija. Kā notiek procedūra?" },
  { route: "/lv/raksti/kam-tiek-kompenseti-zobu-implanti",   title: "Kam tiek kompensēti zobu implanti? | Bangų klinika",                description: "Ierastie zobu implanti Lietuvā nav automātiski kompensēti visiem. Kā darbojas zobu protezēšanas kompensācija?" },
  { route: "/lv/raksti/cik-ilgi-notiek-mutes-higiena",       title: "Cik ilgi notiek mutes higiēna? | Bangų klinika",                    description: "Profesionālā mutes higiēna visbiežāk ilgst 30–60 minūtes. Kas var pagarināt procedūru un kad vienas vizītes var nepietikt?" },
  { route: "/lv/raksti/cik-ilgi-sap-zobs-pec-kanalu-tirisanas", title: "Cik ilgi sāp zobs pēc kanālu tīrīšanas? | Bangų klinika",         description: "Pēc sakņu kanālu tīrīšanas zobs var būt jutīgs dažas dienas. Kā atšķirt normālu dzīšanu no simptomiem, kurus nevajadzētu ignorēt?" },
  { route: "/lv/raksti/ko-darit-kad-bernam-sap-zobs",        title: "Ko darīt, kad bērnam sāp zobs? | Bangų klinika",                    description: "Kad bērnam sāp zobs, vecākiem var būt grūti saprast, kas noticis. Ko darīt līdz vizītei pie zobārsta?" },
  { route: "/lv/raksti/zoba-implanta-noraidisanas-pazimes",  title: "Zoba implanta noraidīšanas pazīmes | Bangų klinika",                description: "Zobu implanti visbiežāk veiksmīgi ieaug, taču komplikācijas iespējamas. Kā atšķirt normālu dzīšanu no bīstamiem simptomiem?" },
  { route: "/lv/raksti/kas-jazina-pec-zoba-implantacijas",   title: "Kas jāzina pēc zoba implantācijas? | Bangų klinika",                description: "Zoba implantācija ir ķirurģiska procedūra. Kā rūpēties par implantu pirmajās dienās un ilgtermiņā?" },
  { route: "/lv/raksti/kapec-sap-zobs-pec-plombesanas",      title: "Kāpēc sāp zobs pēc plombēšanas? | Bangų klinika",                   description: "Neliels jutīgums pēc plombēšanas bieži ir īslaicīgs, taču sāpes nedrīkstētu ignorēt, ja tās pastiprinās. Kad jāvēršas pie zobārsta?" },
  { route: "/lv/raksti/vai-sap-kad-izrauj-zobu",             title: "Vai sāp, kad izrauj zobu? | Bangų klinika",                         description: "Zoba izraušana daudziem pacientiem rada satraukumu. Vai procedūras laikā sāp un cik ilgi var sāpēt pēc izraušanas?" },
  { route: "/lv/raksti/ko-darit-kad-sap-gudribas-zobs",      title: "Ko darīt, kad sāp gudrības zobs? | Bangų klinika",                  description: "Gudrības zobu sāpes ir viens no biežākajiem iemesliem, kāpēc pacienti steidzas pie zobārsta. Kā rīkoties un kad nepieciešama izraušana?" },
  { route: "/lv/raksti/ko-darit-kad-sap-zobs",               title: "Ko darīt, kad sāp zobs? | Bangų klinika",                           description: "Zoba sāpes bieži pārsteidz negaidīti. Kā rīkoties, kad nepieciešama neatliekamā palīdzība un ko darīt nedēļas nogalē?" },
  {
