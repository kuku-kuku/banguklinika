              ...
              <div className="rounded-3xl border border-sky-200/40 p-7 sm:p-10 lg:p-12" style={{ backgroundColor: SL }}>
                ...
                <div className="grid md:grid-cols-2 gap-5">
                  <div className="bg-white p-6 sm:p-8 rounded-3xl border-2 shadow-sm hover:shadow-xl transition-all" style={{ borderColor: S }}>
                    <h3 className="text-lg font-extrabold mb-4" style={{ color: P }}>Suaugusiųjų gydymas</h3>
              ...
              <div className="grid lg:grid-cols-[5fr_4fr] gap-0 items-stretch">
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  ...
                  <p className="text-slate-700 leading-relaxed mb-6">
                    Bangų odontologijos klinikoje Jūsų laukia profesionali komanda, moderni diagnostika ir individualiai pritaikyti sprendimai. Užsiregistruokite vizitui ir pasirūpinkite savo burnos sveikata užtikrintai – dantų taisymas Klaipėdoje gali būti aiškus, ramus ir patikimas procesas.
                  </p>
