    ...
    <AnimatedSection>
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          ...
          <motion.section
            id="kas-yra"
            className="mb-12 bg-white p-6 sm:p-8 rounded-2xl border border-slate-100 shadow-soft scroll-mt-36 2xl:scroll-mt-24"
            variants={item}
          >
          ...
          <div className="mb-12 space-y-8">
            ...
            <motion.section
              id="po-protezavimo"
              className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-100 shadow-soft scroll-mt-36 2xl:scroll-mt-24"
              variants={item}
            >
              <h2 className="text-xl sm:text-2xl font-semibold text-darkblue-700 mb-4">
