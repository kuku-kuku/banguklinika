    ...
    <AnimatedSection>
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          ...
          <motion.section id="airflow" className="mb-12 bg-white p-6 sm:p-8 rounded-2xl border border-brand/10 scroll-mt-36 2xl:scroll-mt-24" variants={item}>
          ...
          <motion.section id="kada-reikalinga" className="mb-12 scroll-mt-36 2xl:scroll-mt-24" variants={item}>
            ...
            <div className="bg-white p-6 rounded-2xl border border-brand/10">
          ...
          <motion.section id="po-higienos" className="mb-12 scroll-mt-36 2xl:scroll-mt-24" variants={item}>
            ...
            <div className="space-y-4 text-slate-700 leading-relaxed">
              ...
              <div className="bg-white p-6 rounded-xl border border-brand/10">
