    ...
    <AnimatedSection>
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          ...
          <motion.section id="beyond-privalumai" className={sectionWrap} variants={item}>
            <div className={whiteCard}>
              <h2 className="text-xl sm:text-2xl font-semibold text-darkblue-700 mb-6">
          ...
          {/* BALINIMAS KAPOMIS */}
          <motion.section id="namie" className={sectionWrap} variants={item}>
            <div className={whiteCard}>
              <h2 className="text-xl sm:text-2xl font-semibold text-darkblue-700 mb-6">
          ...
          {/* PO BALINIMO */}
          <motion.section id="po-balinimo" className={sectionWrap} variants={item}>
            <div className={whiteCard}>
              <h2 className="text-xl sm:text-2xl font-semibold text-darkblue-700 mb-6">
          ...
          {/* REZULTATO TRUKMĖ */}
          <motion.section id="rezultatas" className={sectionWrap} variants={item}>
            <div className={whiteCard}>
              <h2 className="text-xl sm:text-2xl font-semibold text-darkblue-700 mb-4">
          ...
          {/* KAM NETINKA */}
          <motion.section id="kam-netinka" className={sectionWrap} variants={item}>
            <div className={whiteCard}>
              <h2 className="text-xl sm:text-2xl font-semibold text-darkblue-700 mb-6">
