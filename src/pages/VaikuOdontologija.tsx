      ...
      >
        ...
        <div className="min-w-0 flex-1">
          ...
          >
            ...
            <div className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-100 shadow-soft space-y-4 text-slate-700 leading-relaxed">
              <p>
          ...
          {/* KODĖL SVARBU PRIŽIŪRĖTI (KORTELĖS) */}
          <motion.section id="pieniniai" className="mb-12 scroll-mt-36 2xl:scroll-mt-24" variants={item}>
            ...
            <div className="grid sm:grid-cols-3 gap-6">
              <div className="rounded-2xl border border-slate-100 bg-white shadow-soft p-6 flex flex-col items-start">
                <SmileIcon />
