...
export default function MusuDarbiLv() {
  return (
    <AnimatedSection>
      <SEO
        title="Mūsu darbi | Bangų klīnika"
        description="Reāli pacientu rezultāti — All-on-4 implantācija, zobu atjaunošana. Fotogrāfijas pirms un pēc."
        canonical={`${SITE_URL}/lv/musu-darbi`}
        lang="lv"
        alternates={[
          { lang: 'lt', url: `${SITE_URL}/musu-darbai` },
          { lang: 'lv', url: `${SITE_URL}/lv/musu-darbi` },
          { lang: 'x-default', url: `${SITE_URL}/musu-darbai` },
        ]}
      />
      ...
      <div className="container-narrow pt-16 pb-10 sm:pt-24 sm:pb-14">
        <motion.div variants={fadeUp} initial="hidden" animate="visible" className="max-w-xl">
          ...
          <p className="text-slate-500 text-base sm:text-lg leading-relaxed">
            Īsti pacientu gadījumi - fotogrāfijas pirms procedūras un pēc tās.
          </p>
        </motion.div>
        <motion.div
              ...
              <div className={`flex flex-col-reverse ${i % 2 === 1 ? 'lg:flex-row-reverse' : 'lg:flex-row'} gap-8 lg:gap-16 items-start`}>
                ...
                <div className={`w-full lg:w-[38%] pt-1 ${i % 2 === 1 ? 'lg:text-right' : ''}`}>
                  ...
                  <p className="text-slate-500 text-sm leading-relaxed">
                    Izmantojot All-on-4 metodiku, viss zobu loks tiek atjaunots uz 4 implantiem vienā vizītē. Pacients aiziet ar funkcionējošu smaidu tajā pašā dienā.
                  </p>
                </div>
              </div>
        ...
        >
          ...
          <div className="relative z-10 px-8 py-14 sm:px-14 sm:py-20 max-w-lg">
            <p className="text-2xl sm:text-3xl font-extrabold text-slate-900 leading-tight mb-3">
              Vēlaties šādu rezultātu?
            </p>
            <p className="text-slate-500 text-base mb-8">
              Sazinieties — apspriedīsim jums piemērotāko risinājumu.
            </p>
