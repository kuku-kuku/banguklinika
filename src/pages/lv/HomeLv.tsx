...
const POPULAR_SERVICES_LV = [
  ...
  { id: 'zobu-protezesana',   title: 'Digitālā protezēšana (CEREC)', desc: 'Kroņi un uzlikas vienas vizītes laikā ar jaunāko CEREC tehnoloģiju.',                            image: '/protezavimas.webp',        href: '/lv/pakalpojumi/zobu-protezesana' },
  { id: 'zobu-balinesana',    title: 'Zobu balināšana',              desc: 'Droša un efektīva balināšana ar BEYOND® sistēmu kabinetā vai individuālām kapām mājās.',           image: '/balinimas.webp',        href: '/lv/pakalpojumi/zobu-balinesana' },
  { id: 'mutes-higiena',      title: 'Profesionāla mutes higiēna',  desc: 'Aplikumu un akmeņu noņemšana profesionālai mutes dobuma veselības uzturēšanai.',                     image: '/higiena.webp',      href: '/lv/pakalpojumi/mutes-higiena' },
        ...
        <div className="flex items-center gap-2">
          {TEAM.map((_, i) => (
            <button
              ...
              aria-label={`Komandas loceklis ${i + 1}`}
            />
          ))}
        </div>
          ...
          <div className="space-y-8 max-w-2xl">
            <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              <h1 className="text-4xl md:text-5xl lg:text-[3.25rem] font-extrabold leading-[1.1] tracking-tight" style={{ color: C.deepTeal }}>
                Zobārstniecības<br />klīnika Klaipēdā
              </h1>
            </motion.div>
          ...
          <AnimatedSection>
            <div className="text-center mb-5">
              ...
              <p className="mt-4 text-base text-slate-500 max-w-lg mx-auto">
                Pieredzējusi un draudzīga komanda, kas rūpējas par katra pacienta komfortu un veselību.
              </p>
            </div>
          </AnimatedSection>
          <TeamCarousel />
        ...
        <div className={W}>
          <AnimatedSection>
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-3">
              <div>
                <h2 className="text-3xl sm:text-4xl font-bold tracking-tight" style={{ color: C.deepTeal }}>
                  Kāpēc izvēlēties<br />Bangų klīniku?
                </h2>
              </div>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection>
            <div className="relative overflow-hidden rounded-[2rem] bg-white border border-slate-100 shadow-2xl min-h-[320px] md:min-h-[380px] flex items-center">
              ...
              <div className="relative z-10 px-8 py-10 sm:px-12 lg:py-14 max-w-2xl">
                <p className="text-xs font-bold tracking-[0.2em] uppercase mb-4" style={{ color: C.teal }}>Pirmais vizīts</p>
                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold tracking-tight leading-tight" style={{ color: C.deepTeal }}>
                  Sākotnējā konsultācija ir <span style={{ color: C.teal }}>bezmaksas</span>
                </h2>
          ...
          <section className="py-2 pb-8 md:pb-12 cv-auto">
            <div className={W}>
              ...
              <div className="grid md:grid-cols-3 gap-5">
                {BLOG_POSTS_LV.slice(0, 3).map((post, i) => (
                  <motion.div
                    key={post.slug}
                    initial={{ opacity: 0, y: 24 }}
          ...
          <AnimatedSection>
            <div className="max-w-3xl mb-5">
              ...
              <p className="mt-4 text-base lg:text-lg text-slate-500 leading-relaxed">
                Atbildam uz jums interesējošiem jautājumiem par ārstniecību, drošību un procedūru norisi.
              </p>
            </div>
          </AnimatedSection>
