        ...
        <div className="min-w-0 flex-1">
          ...
          <motion.header className="mb-10 text-left" variants={item}>
            ...
            <div id="kainos" className="mt-8 scroll-mt-36 2xl:scroll-mt-24">
              <div className="space-y-5">
                ...
                <div className="w-full rounded-2xl border border-brand/30 bg-white shadow-soft overflow-hidden">
                  <div className="grid md:grid-cols-2">
                    <div className="flex justify-between items-center px-4 py-3 hover:bg-brand-50/30 transition gap-4 md:border-r md:border-brand/20">
                    ...
                    <div className="flex justify-between items-center px-4 py-3 hover:bg-brand-50/30 transition gap-4 border-t border-slate-100 md:border-t-0">
                      <span className="text-slate-700">Dantų tiesinimas ORDOLINE kapų sistema</span>
                      <span className="text-darkblue-700 font-bold whitespace-nowrap">1800 – 4000 €</span>
                    </div>
                  </div>
                </div>
          ...
          <motion.section id="kas-yra" className="mb-12 scroll-mt-36 2xl:scroll-mt-24" variants={item}>
            <div className="space-y-4">
              ...
              <div className="bg-brand-50 p-6 sm:p-8 rounded-2xl border border-brand/30">
          ...
          <motion.section id="ordoline" className="mb-12 scroll-mt-36 2xl:scroll-mt-24" variants={item}>
            <div className="space-y-6">
              ...
              <div className="grid gap-6 md:grid-cols-3">
                <div className="bg-brand-50 p-5 rounded-xl border border-brand/30 shadow-sm">
                  <EyeOffIcon />
          ...
          <motion.section id="procesas" className="mb-12 scroll-mt-36 2xl:scroll-mt-24" variants={item}>
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="bg-brand-50 p-6 rounded-xl border border-brand/30 shadow-sm">
          ...
          <motion.section id="kam-tinka" className="mb-12 scroll-mt-36 2xl:scroll-mt-24" variants={item}>
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border border-brand/30 bg-brand-50 p-6 sm:p-8">
                <h3 className="font-semibold text-darkblue-700 mb-4">Dantų tiesinimas kapomis tinka, jei:</h3>
                <div className="grid sm:grid-cols-1 gap-3 mb-6">
                  {[
                    ...
                    <div key={i} className="flex items-start gap-3 p-3 rounded-lg bg-white border border-brand/30 shadow-sm">
