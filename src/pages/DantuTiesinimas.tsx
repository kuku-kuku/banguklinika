            ...
            <div className={whiteCard}>
              ...
              <div className="space-y-4">
                ...
                <div className={innerCard}>
                  ...
                  <p className="text-slate-600 text-sm">Kapos veikia palaipsniui, tačiau labai tiksliai. Kiekviena kapa yra sukurta konkrečiam dantų judėjimo etapui, todėl laikantis nešiojimo režimo galima pasiekti aiškiai prognozuojamus ir stabilius rezultatus.</p>
                </div>
                <div className={innerCard}>
