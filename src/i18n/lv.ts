...
export const homeLv = {
  seo: {
    ...
    description:
      'Zobārstniecības klīnika Klaipēdā: zobu ārstniecība, implantācija (Straumann®/Neodent®), CEREC protezēšana 1 vizītē, AIRFLOW® higiēna, estētiskā plombēšana. Bezmaksas sākotnējā konsultācija.',
    keywords:
