  ...
  return (
    <form onSubmit={handleSubmit} className="card p-6 space-y-4">
      ...
      <div>
        ...
        <textarea required value={message} onChange={e=>setMessage(e.target.value)} rows={5} className="mt-1 w-full rounded-xl border px-3 py-2" placeholder="Trumpai aprašykite poreikį..." />
      </div>
