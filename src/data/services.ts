...
export const SERVICES: Service[] = [
  ...
  { id: "implantai", title: "Dantų implantacija", description: "Straumann® ir Neodenta® sistemos, vienmomentė implantacija.", highlights: ["3D planavimas", "Mažesnis diskomfortas", "Ilgaamžiai rezultatai"] },
